...
for library_name in library_names:
    ...
    for keys, values in symAndpath.items():
        ...
        print(keys)
        print(values)
        print(symPrsr.symParse_pin(xmlroot, values))
        print(symPrsr.symParse_shape(xmlroot, values))
        print(symPrsr.symParse_text(xmlroot, values))
        print("########################################################")
    ...
    for keys, values in fpAndpath.items():
        ...
        print(keys)
        print(values)
        print(fpPrsr.fpParse_pin(xmlroot, values))
        print(fpPrsr.fpParse_onlySmd(xmlroot, values))
